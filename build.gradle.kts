...
dependencies {
    ...
    val postgresTestContainersVersion = "1.15.3"
...
pitest {
    targetClasses.set(
        arrayListOf(
            "dev.erickvieira.ppcc.service.banking.domain.service.*",
            "dev.erickvieira.ppcc.service.banking.domain.extension.*",
            "dev.erickvieira.ppcc.service.banking.unit.*"
        )
    )
